...
public class AdminController {
    ...
    void initialize() {
        ...
        StatikButton.setOnAction(event -> {
            openFXML("pieChartController.fxml");
        });
    ...
    private void openFXML(String fxmlFileName) {
        try {
            ...
            Stage Stage = (Stage) StatikButton.getScene().getWindow();
            Scene buttonScene = StatikButton.getScene();
            if (buttonScene != null) {
